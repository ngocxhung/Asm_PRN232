...
namespace LibraryManagement_WebAPI.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Author author) => Ok(await _authorRepository.CreateAsync(author));

        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Author author) => Ok(await _authorRepository.UpdateAsync(id, author));
